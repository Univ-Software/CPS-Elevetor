            ...
            <div style={{display:'flex', flexDirection:'column', gap:'24px'}}>
                <div className="backend-card">
                    ...
                    {(() => {
                        ...
                        const isWaitOver  = (misalignWaitTime > 2000 && sensor_Misaligned) ? 1 : 0;
                        ...
                        { id: "LVL", name: "3. 정위치 이탈", desc: "위치오차 + 정지(2초 경과)", bits: [0, 0, s_PosError, isWaitOver, 0], fault: s_PosError && isWaitOver },
                        ];
